const CACHE_NAME = 'bmc-guest-pwa-v48-compact-act-photo-cells';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=compact-act-photo-cells-20260701"></script>`;
