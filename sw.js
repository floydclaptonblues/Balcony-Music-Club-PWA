const CACHE_NAME = 'bmc-guest-pwa-v62-syntax-safe-mobile-lineup';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=20260704-syntax-safe-mobile"></script>`;
