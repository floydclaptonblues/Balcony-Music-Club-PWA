const CACHE_NAME = 'bmc-guest-pwa-v75-alert-copy-boozeball-repair';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
.music-stars .n1{left:8%;top:14%;font-size:96px;animation:musicFloatA 76s ease-in-out infinite;animation-delay:-4s}.music-stars .n2{left:23%;top:72%;font-size:72px;color:rgba(94,230,255,.55);animation:musicFloatB 96s cubic-bezier(.42,0,.58,1) infinite;animation-delay:-18s}.music-stars .n3{left:39%;top:24%;font-size:108px;color:rgba(255,137,207,.52);animation:musicFloatC 88s ease-in-out infinite;animation-delay:-32s}.music-stars .n4{left:57%;top:82%;font-size:84px;color:rgba(255,229,122,.58);animation:musicFloatD 104s cubic-bezier(.36,0,.64,1) infinite;animation-delay:-11s}.music-stars .n5{left:72%;top:18%;font-size:78px;color:rgba(255,255,255,.52);animation:musicFloatE 90s ease-in-out infinite;animation-delay:-41s}.music-stars .n6{left:88%;top:58%;font-size:120px;color:rgba(94,230,255,.48);animation:musicFloatA 112s cubic-bezier(.42,0,.58,1) infinite reverse;animation-delay:-27s}.music-stars .n7{left:14%;top:44%;font-size:66px;color:rgba(255,255,255,.38);animation:musicFloatB 120s ease-in-out infinite reverse;animation-delay:-54s}.music-stars .n8{left:64%;top:42%;font-size:90px;color:rgba(255,229,122,.50);animation:musicFloatC 84s cubic-bezier(.36,0,.64,1) infinite;animation-delay:-8s}.music-stars .n9{left:81%;top:76%;font-size:72px;color:rgba(255,137,207,.42);animation:musicFloatD 108s ease-in-out infinite reverse;animation-delay:-63s}.music-stars .n10{left:46%;top:61%;font-size:60px;color:rgba(94,230,255,.42);animation:musicFloatE 118s cubic-bezier(.42,0,.58,1) infinite;animation-delay:-21s}.music-stars .n11{left:5%;top:62%;font-size:102px;color:rgba(255,229,122,.46);animation:musicFloatC 92s ease-in-out infinite reverse;animation-delay:-48s}.music-stars .n12{left:18%;top:27%;font-size:84px;color:rgba(94,230,255,.44);animation:musicFloatD 116s cubic-bezier(.36,0,.64,1) infinite;animation-delay:-36s}.music-stars .n13{left:31%;top:86%;font-size:114px;color:rgba(255,137,207,.38);animation:musicFloatA 100s ease-in-out infinite reverse;animation-delay:-15s}.music-stars .n14{left:52%;top:12%;font-size:72px;color:rgba(255,255,255,.42);animation:musicFloatB 126s cubic-bezier(.42,0,.58,1) infinite;animation-delay:-70s}.music-stars .n15{left:69%;top:66%;font-size:96px;color:rgba(255,229,122,.44);animation:musicFloatE 98s ease-in-out infinite reverse;animation-delay:-26s}.music-stars .n16{left:92%;top:31%;font-size:78px;color:rgba(94,230,255,.38);animation:musicFloatC 132s cubic-bezier(.36,0,.64,1) infinite;animation-delay:-59s}.music-stars .n17{left:35%;top:48%;font-size:66px;color:rgba(255,255,255,.34);animation:musicFloatD 122s ease-in-out infinite reverse;animation-delay:-44s}.music-stars .n18{left:76%;top:7%;font-size:108px;color:rgba(255,137,207,.36);animation:musicFloatA 106s cubic-bezier(.42,0,.58,1) infinite;animation-delay:-12s}.music-stars .n19{left:3%;top:82%;font-size:72px;color:rgba(94,230,255,.36);animation:musicFloatB 134s ease-in-out infinite reverse;animation-delay:-81s}.music-stars .n20{left:58%;top:55%;font-size:120px;color:rgba(255,229,122,.32);animation:musicFloatE 140s cubic-bezier(.36,0,.64,1) infinite;animation-delay:-51s}
...
.boozeball-marquee-shell{display:block!important;position:relative;z-index:5;margin:8px 0 18px;padding:10px;background:linear-gradient(180deg,rgba(255,216,87,.9),rgba(255,74,176,.72));border:2px solid #000;border-radius:16px;box-shadow:0 0 24px rgba(255,216,87,.36),0 10px 30px rgba(255,74,176,.22);overflow:hidden}.boozeball-marquee-link{display:block!important;position:relative;overflow:hidden;min-height:58px;border:2px solid #000;border-radius:12px;background:linear-gradient(90deg,#190724,#4b1380,#190724);color:#fff7d6;text-decoration:none;text-shadow:2px 2px 0 #000;box-shadow:inset 0 0 0 3px rgba(94,230,255,.65);animation:boozeBlink .9s steps(2,end) infinite}.boozeball-marquee-track{display:flex;width:max-content;white-space:nowrap;animation:boozeScroll 10s linear infinite}.boozeball-marquee-track span{display:inline-flex;align-items:center;min-height:58px;padding:0 34px;font-family:Chicago,Charcoal,Geneva,'Arial Rounded MT Bold',Verdana,sans-serif;text-transform:uppercase;letter-spacing:.08em;font-size:clamp(16px,5vw,29px);font-weight:1000;color:#ffe57a}.boozeball-card{border-color:rgba(255,216,87,.68);background:linear-gradient(180deg,rgba(255,216,87,.12),rgba(255,74,176,.07)),linear-gradient(180deg,rgba(50,25,86,.86),rgba(20,7,35,.88))}.boozeball-lede{font-size:16px;color:#fff6e8;margin-top:0}.boozeball-photo-grid{display:grid;grid-template-columns:1fr;gap:10px;margin:12px 0}.boozeball-photo-grid img{display:block;width:100%;height:auto;border:2px solid #000;border-radius:14px;background:#120728;box-shadow:0 8px 28px rgba(0,0,0,.42)}.boozeball-menu{display:grid;grid-template-columns:1fr;gap:10px;margin-top:12px}.boozeball-menu article{border:2px solid #000;border-radius:12px;background:rgba(0,0,0,.24);padding:12px}.boozeball-menu h3{color:#ffe57a;margin-bottom:6px}.boozeball-menu ul{list-style:none;margin:0;padding:0;columns:1}.boozeball-menu li{font-weight:900;color:#fff6e8;font-size:14px;line-height:1.65}@keyframes boozeBlink{0%,49%{filter:saturate(1.15) brightness(1.08)}50%,100%{filter:saturate(2.05) brightness(1.42)}}@keyframes boozeScroll{from{transform:translate3d(0,0,0)}to{transform:translate3d(-50%,0,0)}}@media(min-width:760px){.boozeball-photo-grid{grid-template-columns:1.1fr .9fr}.boozeball-menu{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (prefers-reduced-motion:reduce){.boozeball-marquee-link,.boozeball-marquee-track{animation:none}.boozeball-marquee-track{transform:none}}
</style>`;

const BOOZEBALL_SPECIALS_SECTION = `<section class="boozeball-marquee-shell" aria-label="BMC BoozeBall special"><a class="boozeball-marquee-link" href="#boozeball"><span class="boozeball-marquee-track"><span>The Slammin' $7 BMC BoozeBall.....Try Now!!!</span><span>The Slammin' $7 BMC BoozeBall.....Try Now!!!</span><span>The Slammin' $7 BMC BoozeBall.....Try Now!!!</span><span>The Slammin' $7 BMC BoozeBall.....Try Now!!!</span></span></a></section><section id="boozeball" class="panel boozeball-card"><span class="ribbon">Drink Special</span><h2>The Slammin' $7 BMC BoozeBall</h2><p class="boozeball-lede"><strong>Available now at the Patio Bar.</strong> Choose Absolut plus puree flavor and make it a cold little BMC party ball.</p><div class="boozeball-photo-grid"><img src="assets/venue/1000019805.jpg" alt="BMC BoozeBalls patio bar promo showing seven flavors available now"><img src="assets/venue/1000019788.jpg" alt="BMC Boozy Balls flavor menu with Absolut and puree flavor options"></div><div class="boozeball-menu"><article><h3>Absolut flavors</h3><ul><li>🍋 Citrus</li><li>💚 Lime</li><li>🥭 Mango</li><li>🍊 Mandarine</li><li>🌶️ Pepper</li><li>🍓 Raspberry</li><li>🫐 Wildberry</li></ul></article><article><h3>Puree flavors</h3><ul><li>🍓 Strawberry</li><li>🫐 Blueberry</li><li>⭐ Passion</li><li>🍓 Strawberry</li><li>🍈 Guava</li><li>🍈 Guava</li><li>⭐ Passion Fruit</li></ul></article></div></section>`;
...
const APP_REPAIR_SCRIPT = `<script id="bmc-live-copy-repair">
(function(){
  var copy=${JSON.stringify(ALERT_COPY)};
  function repair(){
    var notify=document.getElementById('notify');
    if(notify){
      var intro=notify.querySelector('article.card > p');
      if(intro) intro.textContent=copy;
      notify.querySelectorAll('article.card').forEach(function(card){var text=card.textContent||''; if(/Tonight.s BMC show announcements|Wed.Sun schedule reminders|Special event notices when approved/.test(text)) card.remove();});
      var pref=Array.from(notify.querySelectorAll('h3')).find(function(h){return /Local guest preferences|Alert Topics/i.test(h.textContent||'');});
      if(pref) pref.textContent='ALERT TOPICS';
      var labels=notify.querySelectorAll('.toggle span');
      if(labels[0]) labels[0].textContent='Drink Specials!';
      if(labels[1]) labels[1].textContent='Exclusive Member Discounts!';
      if(labels[2]) labels[2].textContent='Special Event Invitations!';
    }
    if(!document.getElementById('boozeball')){
      var anchor=document.querySelector('.marquee-shell')||document.getElementById('home');
      if(anchor) anchor.insertAdjacentHTML('afterend', ${JSON.stringify(BOOZEBALL_SPECIALS_SECTION)});
    }
    var nav=document.querySelector('header nav,.top nav,nav');
    if(nav && !nav.querySelector('a[href="#boozeball"]')){var a=document.createElement('a');a.href='#boozeball';a.textContent='BoozeBall';nav.insertBefore(a,nav.querySelector('a[href="#book"]')||null);}
  }
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',repair); else repair();
  window.addEventListener('load',function(){repair();setTimeout(repair,250);setTimeout(repair,1000);});
})();
</script>`;
...
function patchAlertTopicCopy(html) {
  return html
    ...
    .replace(/<p>Tap Enable Show Alerts below\. Your browser will ask for notification permission before BMC can send Wed–Sun show announcements to this device\.<\/p>/g, '<p>' + ALERT_COPY + '</p>')
...
function patchBoozeBallSpecials(html) {
  ...
  if (!patched.includes('href="#boozeball"')) patched = patched.replace('<a href="#events">Events</a>', '<a href="#events">Events</a><a href="#boozeball">BoozeBall</a>');
  if (!patched.includes('id="boozeball"')) {
    const noCover = '<section class="marquee-shell"><div class="marquee"><span class="big">No Cover • No Charge</span><p>Scan, save, and check the July lineup.</p></div></section>';
    if (patched.includes(noCover)) patched = patched.replace(noCover, noCover + BOOZEBALL_SPECIALS_SECTION);
    else patched = patched.replace('<section id="book"', BOOZEBALL_SPECIALS_SECTION + '<section id="book"');
  }
  if (!patched.includes('bmc-live-copy-repair')) patched = patched.replace('</body>', APP_REPAIR_SCRIPT + '</body>');
  return patched;
}
