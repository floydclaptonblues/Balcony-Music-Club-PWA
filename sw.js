const CACHE_NAME = 'bmc-guest-pwa-v47-july4-act-photo-fix';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=july4-act-photo-fix-20260630"></script>`;
