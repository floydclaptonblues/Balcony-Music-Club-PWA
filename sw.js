const CACHE_NAME = 'bmc-guest-pwa-v49-marquee-artist-day';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=marquee-artist-day-20260701"></script>`;
