const CACHE_NAME = 'bmc-guest-pwa-v50-john-lisi-management';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=john-lisi-management-20260701"></script>`;
