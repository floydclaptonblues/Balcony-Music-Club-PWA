const CACHE_NAME = 'bmc-guest-pwa-v60-weekly-lineup-clamp';
const CORE_ASSETS = [
  '/',
  '/index.html',
...
const SCHEDULE_AUTHORITY_PATCH = `<script src="assets/bot/schedule-authority-patch.js?v=july-schedule-20260704-mobile-clamp"></script>`;
